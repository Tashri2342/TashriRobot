...
import TashriRobot
import TashriRobot.modules.sql.welcome_sql as sql
...
from TashriRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from TashriRobot.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                if not TashriRobot.ALLOW_CHATS:
...
from TashriRobot import BOT_NAME
from TashriRobot import pbot as app
OWNERs_ID=5105943340
@app.on_message(
