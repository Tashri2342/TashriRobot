...
import TashriRobot.modules.sql.global_bans_sql as gban_sql
import TashriRobot.modules.sql.users_sql as user_sql
from TashriRobot import DEV_USERS, OWNER_ID, dispatcher
