...
from TashriRobot import OWNER_ID, pbot
from TashriRobot.utils.admins import can_change_info
from TashriRobot.utils.errors import capture_err
from TashriRobot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote = r"^((?i)\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤|💘|cool|good|👍|baby|Tashri|thank you|gud|thankyou|love|pro)$"
