...
import TashriRobot.modules.sql.userinfo_sql as sql
...
from TashriRobot import telethn as TashriTelethonClient
from TashriRobot.__main__ import STATS, TOKEN, USER_INFO
from TashriRobot.modules.disable import DisableAbleCommandHandler
from TashriRobot.modules.helper_funcs.chat_status import sudo_plus
from TashriRobot.modules.helper_funcs.extraction import extract_user
from TashriRobot.modules.sql.afk_sql import check_afk_status, is_afk
from TashriRobot.modules.sql.global_bans_sql import is_user_gbanned
from TashriRobot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Tashribots2342/14">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
