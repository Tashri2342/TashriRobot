...
# from TashriRobot.modules.sql import warns_sql as warnssql
import TashriRobot.modules.sql.blacklist_sql as blacklistsql

# from TashriRobot.modules.sql import cust_filters_sql as filtersql
# import TashriRobot.modules.sql.welcome_sql as welcsql
import TashriRobot.modules.sql.locks_sql as locksql
import TashriRobot.modules.sql.notes_sql as sql

# from TashriRobot.modules.rules import get_rules
import TashriRobot.modules.sql.rules_sql as rulessql
from TashriRobot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from TashriRobot.__main__ import DATA_IMPORT
from TashriRobot.modules.connection import connected
from TashriRobot.modules.helper_funcs.alternate import typing_action
from TashriRobot.modules.helper_funcs.chat_status import user_admin
from TashriRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("TashriRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("TashriRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `TashriRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("TashriRobot{}.backup".format(chat_id))  # Cleaning file
